       ...
       try {
           ...
           for (Row row : sheet){
               ...
               while (cellIterator.hasNext()){
                   ...
                   switch (cellIndex){
                       case 0 -> customer.setFirstName(cell.getStringCellValue());
                       case 1 -> customer.setLastName(cell.getStringCellValue());
                       case 2 -> customer.setCountry(cell.getStringCellValue());
                       case 3 -> customer.setTelephone((int) cell.getNumericCellValue());
                       default -> {
                       }
                   }
                   cellIndex++;
